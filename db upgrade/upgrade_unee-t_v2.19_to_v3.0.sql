...
# The procedure we create require the following tables to be created
#	- ut_user_group_map_temp
#	
# The procedure we created REQUIRE the following variables to be defined BEFORE they can run
#	- update_assignee_if_dummy_user
...
# We then create a trigger when a new inviation is added:
