...
# What are the version of the Unee-T BZ Database schema BEFORE and AFTER this update?
	SET @old_schema_version = 'v5.39.0';
	SET @new_schema_version = 'v5.39.1';
#
...
###############################
# In this update
#	- Rename the `push` function to `ut_lambda2sqs_push`. Tnis is a drop-in replacement for `alambda_simple`
#
#
#####################
#
