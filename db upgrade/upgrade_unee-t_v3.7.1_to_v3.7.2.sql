...
# What are the version of the Unee-T BZ Database schema BEFORE and AFTER this update?
	SET @old_schema_version = 'v3.7.1';
	SET @new_schema_version = 'v3.7.2';
	SET @this_script = 'upgrade_unee-t_v3.7.1_to_v3.7.2.sql';
#
###############################
#
...
###############################
# This update 
#	- Re-enable the call to the Lambda procedure in the Prod environment
#

# When are we doing this?
	SET @the_timestamp = NOW();

# Re-enable the trigger to call the lambda procedure each time a new notification is needed
# We are modifying the trigger that update the table 'ut_notification_messages_cases' to add the lambda call there

# We re-enable the lambda call in the trigger when a case is created
...
# We re-enable the trigger when a case is updated
...
# We re-enable the trigger when a new message is added
