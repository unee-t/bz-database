...
# What are the version of the Unee-T BZ Database schema BEFORE and AFTER this update?
	SET @old_schema_version = 'v3.25';
	SET @new_schema_version = 'v3.26';
#
# What is the name of this script?
	SET @this_script = 'upgrade_unee-t_v3.25_to_v3.26.sql';
#
...
# This update
#
#   - Update the procedure `add_user_to_role_in_unit` make sure we Revoke permissions before we create the temp table for user_group_map
#
...
# Create a procedure to invite a user to a role in a unit
