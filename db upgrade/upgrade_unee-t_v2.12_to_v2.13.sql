...
# Alter the list of group types: add new groups and change the group_type names (remove spaces)
...
# Create a table to list all the possible permissions that we can grant to a user (linked to the group_types)
