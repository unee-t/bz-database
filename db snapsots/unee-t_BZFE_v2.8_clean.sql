...
(1,'Bugzilla::Field',1,'__create__',NULL,'bug_id',NOW()),
(1,'Bugzilla::Field',2,'__create__',NULL,'short_desc',NOW()),
(1,'Bugzilla::Field',3,'__create__',NULL,'classification',NOW()),
(1,'Bugzilla::Field',4,'__create__',NULL,'product',NOW()),
(1,'Bugzilla::Field',5,'__create__',NULL,'version',NOW()),
(1,'Bugzilla::Field',6,'__create__',NULL,'rep_platform',NOW()),
(1,'Bugzilla::Field',7,'__create__',NULL,'bug_file_loc',NOW()),
(1,'Bugzilla::Field',8,'__create__',NULL,'op_sys',NOW()),
(1,'Bugzilla::Field',9,'__create__',NULL,'bug_status',NOW()),
(1,'Bugzilla::Field',10,'__create__',NULL,'status_whiteboard',NOW()),
(1,'Bugzilla::Field',11,'__create__',NULL,'keywords',NOW()),
(1,'Bugzilla::Field',12,'__create__',NULL,'resolution',NOW()),
(1,'Bugzilla::Field',13,'__create__',NULL,'bug_severity',NOW()),
(1,'Bugzilla::Field',14,'__create__',NULL,'priority',NOW()),
(1,'Bugzilla::Field',15,'__create__',NULL,'component',NOW()),
(1,'Bugzilla::Field',16,'__create__',NULL,'assigned_to',NOW()),
(1,'Bugzilla::Field',17,'__create__',NULL,'reporter',NOW()),
(1,'Bugzilla::Field',18,'__create__',NULL,'qa_contact',NOW()),
(1,'Bugzilla::Field',19,'__create__',NULL,'assigned_to_realname',NOW()),
(1,'Bugzilla::Field',20,'__create__',NULL,'reporter_realname',NOW()),
(1,'Bugzilla::Field',21,'__create__',NULL,'qa_contact_realname',NOW()),
(1,'Bugzilla::Field',22,'__create__',NULL,'cc',NOW()),
(1,'Bugzilla::Field',23,'__create__',NULL,'dependson',NOW()),
(1,'Bugzilla::Field',24,'__create__',NULL,'blocked',NOW()),
(1,'Bugzilla::Field',25,'__create__',NULL,'attachments.description',NOW()),
(1,'Bugzilla::Field',26,'__create__',NULL,'attachments.filename',NOW()),
(1,'Bugzilla::Field',27,'__create__',NULL,'attachments.mimetype',NOW()),
(1,'Bugzilla::Field',28,'__create__',NULL,'attachments.ispatch',NOW()),
(1,'Bugzilla::Field',29,'__create__',NULL,'attachments.isobsolete',NOW()),
(1,'Bugzilla::Field',30,'__create__',NULL,'attachments.isprivate',NOW()),
(1,'Bugzilla::Field',31,'__create__',NULL,'attachments.submitter',NOW()),
(1,'Bugzilla::Field',32,'__create__',NULL,'target_milestone',NOW()),
(1,'Bugzilla::Field',33,'__create__',NULL,'creation_ts',NOW()),
(1,'Bugzilla::Field',34,'__create__',NULL,'delta_ts',NOW()),
(1,'Bugzilla::Field',35,'__create__',NULL,'longdesc',NOW()),
(1,'Bugzilla::Field',36,'__create__',NULL,'longdescs.isprivate',NOW()),
(1,'Bugzilla::Field',37,'__create__',NULL,'longdescs.count',NOW()),
(1,'Bugzilla::Field',38,'__create__',NULL,'alias',NOW()),
(1,'Bugzilla::Field',39,'__create__',NULL,'everconfirmed',NOW()),
(1,'Bugzilla::Field',40,'__create__',NULL,'reporter_accessible',NOW()),
(1,'Bugzilla::Field',41,'__create__',NULL,'cclist_accessible',NOW()),
(1,'Bugzilla::Field',42,'__create__',NULL,'bug_group',NOW()),
(1,'Bugzilla::Field',43,'__create__',NULL,'estimated_time',NOW()),
(1,'Bugzilla::Field',44,'__create__',NULL,'remaining_time',NOW()),
(1,'Bugzilla::Field',45,'__create__',NULL,'deadline',NOW()),
(1,'Bugzilla::Field',46,'__create__',NULL,'commenter',NOW()),
(1,'Bugzilla::Field',47,'__create__',NULL,'flagtypes.name',NOW()),
(1,'Bugzilla::Field',48,'__create__',NULL,'requestees.login_name',NOW()),
(1,'Bugzilla::Field',49,'__create__',NULL,'setters.login_name',NOW()),
(1,'Bugzilla::Field',50,'__create__',NULL,'work_time',NOW()),
(1,'Bugzilla::Field',51,'__create__',NULL,'percentage_complete',NOW()),
(1,'Bugzilla::Field',52,'__create__',NULL,'content',NOW()),
(1,'Bugzilla::Field',53,'__create__',NULL,'attach_data.thedata',NOW()),
(1,'Bugzilla::Field',54,'__create__',NULL,'owner_idle_time',NOW()),
(1,'Bugzilla::Field',55,'__create__',NULL,'see_also',NOW()),
(1,'Bugzilla::Field',56,'__create__',NULL,'tag',NOW()),
(1,'Bugzilla::Field',57,'__create__',NULL,'last_visit_ts',NOW()),
(1,'Bugzilla::Field',58,'__create__',NULL,'comment_tag',NOW()),
(1,'Bugzilla::Field',59,'__create__',NULL,'days_elapsed',NOW()),
(1,'Bugzilla::Classification',1,'__create__',NULL,'Unclassified',NOW()),
(1,'Bugzilla::Group',1,'__create__',NULL,'admin',NOW()),
(1,'Bugzilla::Group',2,'__create__',NULL,'tweakparams',NOW()),
(1,'Bugzilla::Group',3,'__create__',NULL,'editusers',NOW()),
(1,'Bugzilla::Group',4,'__create__',NULL,'creategroups',NOW()),
(1,'Bugzilla::Group',5,'__create__',NULL,'editclassifications',NOW()),
(1,'Bugzilla::Group',6,'__create__',NULL,'editcomponents',NOW()),
(1,'Bugzilla::Group',7,'__create__',NULL,'editkeywords',NOW()),
(1,'Bugzilla::Group',8,'__create__',NULL,'editbugs',NOW()),
(1,'Bugzilla::Group',9,'__create__',NULL,'canconfirm',NOW()),
(1,'Bugzilla::Group',10,'__create__',NULL,'bz_canusewhineatothers',NOW()),
(1,'Bugzilla::Group',11,'__create__',NULL,'bz_canusewhines',NOW()),
(1,'Bugzilla::Group',12,'__create__',NULL,'bz_sudoers',NOW()),
(1,'Bugzilla::Group',13,'__create__',NULL,'bz_sudo_protect',NOW()),
(1,'Bugzilla::Group',14,'__create__',NULL,'bz_quip_moderators',NOW()),
(1,'Bugzilla::User',1,'__create__',NULL,'contributor@example.com',NOW()),
(1,'Bugzilla::Product',1,'__create__',NULL,'TestProduct',NOW()),
(1,'Bugzilla::Version',1,'__create__',NULL,'unspecified',NOW()),
(1,'Bugzilla::Milestone',1,'__create__',NULL,'---',NOW()),
(1,'Bugzilla::Component',1,'__create__',NULL,'TestComponent',NOW()),
(1,'Bugzilla::Field',60,'__create__',NULL,'cf_ipi_clust_4_status_in_progress',NOW()),
...
(1,'Bugzilla::Field',81,'sortkey','9900','9905',NOW()),
(1,'Bugzilla::Field',81,'visibility_field_id',NULL,'92',NOW()),
