...
MySQL - 5.7.12 : Database - unee_t_v3.12
*********************************************************************
*/
...
(1,'2018-06-11 14:56:23','case_updated','A case has been updated','A case has been updated.\r\nWe record the following information:\r\n- When was the case updated?\r\n- The unit id\r\n- The case id\r\n- Who did the update\r\n- Which field was updated'),
(2,'2018-06-11 14:56:23','case_assignee_new','User is assigned to a new case','A new case has been created and this is the assigned user for this case.\r\nWe record the following information:\r\n- When did this happen?\r\n- Who created the case?\r\n- What is the unit id?\r\n- What is the case id?\r\n- Who is the user assigned to that case?'),
(3,'2018-06-11 14:56:23','case_assignee_updated','The user assigned to that case has changed','A new user has been assigned to a case.\r\nWe record the following information:\r\n- When did this happen?\r\n- Who made this change?\r\n- What is the unit id?\r\n- What is the case id?\r\n- Who is the new user assigned to that case?'),
(4,'2018-06-11 14:56:23','case_user_invited','A user is invited to a case','A new user has been invited to a case.\r\nThe information we store:\r\n- When has this been done\r\n- What is the unit number\r\n- What is the case number\r\n- Who is the newly invited user\r\n\r\nWe do NOT record who has invited the user as this information is not easily accessible from the trigger we use (insert into the table `cc`)');
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `ut_prepare_message_case_assigned_new` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `ut_prepare_message_case_assigned_new` AFTER INSERT ON `bugs` FOR EACH ROW 
BEGIN
...
/* Procedure structure for procedure `lambda_notification_case_assignee` */

/*!50003 DROP PROCEDURE IF EXISTS  `lambda_notification_case_assignee` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `lambda_notification_case_assignee`(
