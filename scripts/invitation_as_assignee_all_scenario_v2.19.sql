...
#		- We know the invitor
#		- We know the case Id this new user must be Assigned to.
...
# Info about this script
	SET @script = 'invitation_as_assignee_all_scenario_v2.19.sql';
...
# The user who you want to associate to this unit.	
