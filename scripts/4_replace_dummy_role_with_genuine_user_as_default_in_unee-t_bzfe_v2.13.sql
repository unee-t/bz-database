...
# 
# This script will:
# 	- Replace the Default 'dummy user' for this role
#
#	- Components were created with a default user:
...
# The user associated to the first role in this unit.	
	...
	#	- Management company 4
		SET @id_role_type = 4;
		SET @role_user_more = 'Use Unee-T for faster reply';
...
# Info about this script
	SET @script = '4_replace_dummy_role_with_genuine_user_as_default_in_unee-t_bzfe_v2.13.sql';
