...
ALTER TABLE `attach_data` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL first , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `attachments` 
	...
	CHANGE `submitter_id` `submitter_id` mediumint(9) unsigned   NOT NULL after `filename` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `audit_log` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NULL first , 
	CHANGE `class` `class` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `user_id` , 
	CHANGE `object_id` `object_id` int(11) unsigned   NOT NULL after `class` , 
	CHANGE `field` `field` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `object_id` , 
	CHANGE `removed` `removed` longtext  COLLATE utf8mb4_unicode_520_ci NULL after `field` , 
	CHANGE `added` `added` longtext  COLLATE utf8mb4_unicode_520_ci NULL after `removed` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `bug_group_map` 
	...
	CHANGE `group_id` `group_id` mediumint(9) unsigned   NOT NULL after `bug_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `bug_see_also` 
	...
	CHANGE `value` `value` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `bug_id` , 
	CHANGE `class` `class` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `value` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `bug_severity` 
	CHANGE `id` `id` smallint(6) unsigned   NOT NULL auto_increment first , 
	CHANGE `value` `value` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `sortkey` `sortkey` smallint(6) unsigned   NOT NULL DEFAULT 0 after `value` , 
	CHANGE `visibility_value_id` `visibility_value_id` smallint(6) unsigned   NULL after `isactive` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `bug_tag` 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `tag_id` `tag_id` mediumint(9) unsigned   NOT NULL after `bug_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `bug_user_last_visit` 
	CHANGE `id` `id` int(11) unsigned   NOT NULL auto_increment first , 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NOT NULL after `user_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `bugs` 
	...
	CHANGE `bug_severity` `bug_severity` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `bug_file_loc` , 
	CHANGE `bug_status` `bug_status` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `bug_severity` , 
	CHANGE `short_desc` `short_desc` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `delta_ts` , 
	CHANGE `op_sys` `op_sys` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `short_desc` , 
	CHANGE `priority` `priority` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `op_sys` , 
	CHANGE `product_id` `product_id` mediumint(9) unsigned   NOT NULL after `priority` , 
	CHANGE `rep_platform` `rep_platform` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `product_id` , 
	CHANGE `reporter` `reporter` mediumint(9) unsigned   NOT NULL after `rep_platform` , 
	CHANGE `version` `version` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `reporter` , 
	CHANGE `component_id` `component_id` mediumint(9) unsigned   NOT NULL after `version` , 
	CHANGE `resolution` `resolution` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `component_id` , 
	...
	ADD COLUMN `cf_ut_org_specific_dd_1` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '---' after `cf_specific_for` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `bugs_activity` 
	...
	CHANGE `added` `added` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `fieldid` , 
	CHANGE `removed` `removed` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `added` , 
	CHANGE `comment_id` `comment_id` int(11) unsigned   NULL after `removed` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `bugs_aliases` 
	CHANGE `alias` `alias` varchar(40)  COLLATE utf8mb4_unicode_520_ci NOT NULL first , 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NULL after `alias` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `bugs_fulltext` 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `short_desc` `short_desc` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `bug_id` , 
	...
	DROP FOREIGN KEY `fk_bugs_fulltext_bug_id_bugs_bug_id`  , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `bz_schema` DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `category_group_map` 
	CHANGE `category_id` `category_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `group_id` `group_id` mediumint(9) unsigned   NOT NULL after `category_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `cc` 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `who` `who` mediumint(9) unsigned   NOT NULL after `bug_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `classifications` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `description` `description` longtext  COLLATE utf8mb4_unicode_520_ci NULL after `name` , 
	CHANGE `sortkey` `sortkey` smallint(6) unsigned   NOT NULL DEFAULT 0 after `description` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `component_cc` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `component_id` `component_id` mediumint(9) unsigned   NOT NULL after `user_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `components` 
	...
	CHANGE `description` `description` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `initialqacontact` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `dependencies` 
	CHANGE `blocked` `blocked` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `dependson` `dependson` mediumint(9) unsigned   NOT NULL after `blocked` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `duplicates` 
	CHANGE `dupe_of` `dupe_of` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `dupe` `dupe` mediumint(9) unsigned   NOT NULL after `dupe_of` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
/* Alter table in target */
ALTER TABLE `email_setting` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL first , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `field_visibility` 
	CHANGE `field_id` `field_id` mediumint(9) unsigned   NULL first , 
	CHANGE `value_id` `value_id` smallint(6) unsigned   NOT NULL after `field_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `fielddefs` 
	...
	CHANGE `long_desc` `long_desc` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `description` , 
	...
	CHANGE `reverse_desc` `reverse_desc` text  COLLATE utf8mb4_unicode_520_ci NULL after `value_field_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `flagexclusions` 
	...
	CHANGE `component_id` `component_id` mediumint(9) unsigned   NULL after `product_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `flags` 
	...
	CHANGE `status` `status` char(1)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `type_id` , 
	...
	CHANGE `requestee_id` `requestee_id` mediumint(9) unsigned   NULL after `setter_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `flagtypes` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(50)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `description` `description` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , 
	CHANGE `cc_list` `cc_list` varchar(200)  COLLATE utf8mb4_unicode_520_ci NULL after `description` , 
	CHANGE `target_type` `target_type` char(1)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'b' after `cc_list` , 
	...
	CHANGE `request_group_id` `request_group_id` mediumint(9) unsigned   NULL after `grant_group_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `group_control_map` 
	CHANGE `group_id` `group_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `product_id` `product_id` mediumint(9) unsigned   NOT NULL after `group_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `group_group_map` 
	...
	ADD KEY `group_group_map_member_id_grant_type_idx`(`member_id`,`grant_type`) , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `groups` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `description` `description` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , 
	CHANGE `userregexp` `userregexp` text  COLLATE utf8mb4_unicode_520_ci NOT NULL after `isbuggroup` , 
	CHANGE `icon_url` `icon_url` text  COLLATE utf8mb4_unicode_520_ci NULL after `isactive` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `keyworddefs` 
	CHANGE `id` `id` smallint(6) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `description` `description` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `keywords` 
	CHANGE `bug_id` `bug_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `keywordid` `keywordid` smallint(6) unsigned   NOT NULL after `bug_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `login_failure` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `ip_addr` `ip_addr` varchar(40)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `login_time` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `logincookies` 
	...
	CHANGE `ipaddr` `ipaddr` varchar(40)  COLLATE utf8mb4_unicode_520_ci NULL after `userid` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `longdescs` 
	...
	CHANGE `extra_data` `extra_data` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `type` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `longdescs_tags` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `comment_id` `comment_id` int(11) unsigned   NULL after `id` , 
	CHANGE `tag` `tag` varchar(24)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `comment_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `longdescs_tags_activity` 
	...
	CHANGE `added` `added` varchar(24)  COLLATE utf8mb4_unicode_520_ci NULL after `bug_when` , 
	CHANGE `removed` `removed` varchar(24)  COLLATE utf8mb4_unicode_520_ci NULL after `added` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `longdescs_tags_weights` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `tag` `tag` varchar(24)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `weight` `weight` mediumint(9) unsigned   NOT NULL after `tag` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `mail_staging` 
	CHANGE `id` `id` int(11) unsigned   NOT NULL auto_increment first , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `milestones` 
	...
	CHANGE `sortkey` `sortkey` smallint(6) unsigned   NOT NULL DEFAULT 0 after `value` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `namedqueries` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `userid` `userid` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `userid` , 
	CHANGE `query` `query` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `namedqueries_link_in_footer` 
	CHANGE `namedquery_id` `namedquery_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL after `namedquery_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `namedquery_group_map` 
	CHANGE `namedquery_id` `namedquery_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `group_id` `group_id` mediumint(9) unsigned   NOT NULL after `namedquery_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `products` 
	...
	CHANGE `defaultmilestone` `defaultmilestone` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '---' after `isactive` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `profile_search` 
	...
	CHANGE `list_order` `list_order` longtext  COLLATE utf8mb4_unicode_520_ci NULL after `bug_list` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `profile_setting` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `setting_name` `setting_name` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `user_id` , 
	CHANGE `setting_value` `setting_value` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `setting_name` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `profiles` 
	CHANGE `userid` `userid` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `login_name` `login_name` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `userid` , 
	CHANGE `cryptpassword` `cryptpassword` varchar(128)  COLLATE utf8mb4_unicode_520_ci NULL after `login_name` , 
	CHANGE `realname` `realname` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `cryptpassword` , 
	CHANGE `disabledtext` `disabledtext` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `realname` , 
	CHANGE `extern_id` `extern_id` varchar(64)  COLLATE utf8mb4_unicode_520_ci NULL after `mybugslink` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `profiles_activity` 
	...
	CHANGE `newvalue` `newvalue` text  COLLATE utf8mb4_unicode_520_ci NULL after `oldvalue` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `quips` 
	...
	CHANGE `quip` `quip` varchar(512)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `userid` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `reports` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `user_id` , 
	CHANGE `query` `query` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `series` 
	...
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `subcategory` , 
	CHANGE `frequency` `frequency` smallint(6) unsigned   NOT NULL after `name` , 
	CHANGE `query` `query` longtext  COLLATE utf8mb4_unicode_520_ci NOT NULL after `frequency` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `series_categories` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `series_data` 
	CHANGE `series_id` `series_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `series_value` `series_value` mediumint(9) unsigned   NOT NULL after `series_date` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `setting` 
	CHANGE `name` `name` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL first , 
	CHANGE `default_value` `default_value` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , 
	CHANGE `subclass` `subclass` varchar(32)  COLLATE utf8mb4_unicode_520_ci NULL after `is_enabled` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `setting_value` 
	CHANGE `name` `name` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL first , 
	CHANGE `value` `value` varchar(32)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `name` , 
	CHANGE `sortindex` `sortindex` smallint(6) unsigned   NOT NULL after `value` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `status_workflow` 
	CHANGE `old_status` `old_status` smallint(6) unsigned   NULL first , 
	CHANGE `new_status` `new_status` smallint(6) unsigned   NOT NULL after `old_status` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `tag` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `name` `name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL after `name` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `tokens` 
	...
	CHANGE `tokentype` `tokentype` varchar(16)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `token` , 
	CHANGE `eventdata` `eventdata` text  COLLATE utf8mb4_unicode_520_ci NULL after `tokentype` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `ts_error` 
	...
	CHANGE `message` `message` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `jobid` , 
	CHANGE `funcid` `funcid` int(11) unsigned   NOT NULL DEFAULT 0 after `message` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `ts_exitstatus` 
	...
	CHANGE `delete_after` `delete_after` int(11) unsigned   NULL after `completion_time` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `ts_funcmap` 
	CHANGE `funcid` `funcid` int(11) unsigned   NOT NULL auto_increment first , 
	CHANGE `funcname` `funcname` varchar(255)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `funcid` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `ts_job` 
	CHANGE `jobid` `jobid` int(11) unsigned   NOT NULL auto_increment first , 
	CHANGE `funcid` `funcid` int(11) unsigned   NOT NULL after `jobid` , 
	CHANGE `uniqkey` `uniqkey` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `arg` , 
	...
	CHANGE `coalesce` `coalesce` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `priority` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `ts_note` 
	CHANGE `jobid` `jobid` int(11) unsigned   NOT NULL first , 
	CHANGE `notekey` `notekey` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `jobid` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `user_api_keys` 
	CHANGE `id` `id` int(11) unsigned   NOT NULL auto_increment first , 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `api_key` `api_key` varchar(40)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `user_id` , 
	CHANGE `description` `description` varchar(255)  COLLATE utf8mb4_unicode_520_ci NULL after `api_key` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `user_group_map` 
	CHANGE `user_id` `user_id` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `group_id` `group_id` mediumint(9) unsigned   NOT NULL after `user_id` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
...
ALTER TABLE `versions` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `value` `value` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL after `id` , 
	CHANGE `product_id` `product_id` mediumint(9) unsigned   NOT NULL after `value` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `watch` 
	CHANGE `watcher` `watcher` mediumint(9) unsigned   NOT NULL first , 
	CHANGE `watched` `watched` mediumint(9) unsigned   NOT NULL after `watcher` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `whine_events` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `owner_userid` `owner_userid` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `subject` `subject` varchar(128)  COLLATE utf8mb4_unicode_520_ci NULL after `owner_userid` , 
	CHANGE `body` `body` longtext  COLLATE utf8mb4_unicode_520_ci NULL after `subject` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `whine_queries` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `eventid` `eventid` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `query_name` `query_name` varchar(64)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `eventid` , 
	CHANGE `sortkey` `sortkey` smallint(6) unsigned   NOT NULL DEFAULT 0 after `query_name` , 
	CHANGE `title` `title` varchar(128)  COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '' after `onemailperbug` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;

/* Alter table in target */
ALTER TABLE `whine_schedules` 
	CHANGE `id` `id` mediumint(9) unsigned   NOT NULL auto_increment first , 
	CHANGE `eventid` `eventid` mediumint(9) unsigned   NOT NULL after `id` , 
	CHANGE `run_day` `run_day` varchar(32)  COLLATE utf8mb4_unicode_520_ci NULL after `eventid` , 
	CHANGE `run_time` `run_time` varchar(32)  COLLATE utf8mb4_unicode_520_ci NULL after `run_day` , 
	CHANGE `mailto` `mailto` mediumint(9) unsigned   NOT NULL after `run_next` , 
	CHANGE `mailto_type` `mailto_type` smallint(6) unsigned   NOT NULL DEFAULT 0 after `mailto` , DEFAULT CHARSET='utf8mb4', COLLATE ='utf8mb4_unicode_520_ci' ;
